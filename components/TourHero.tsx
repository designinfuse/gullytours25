        ...
        <section className="relative w-full overflow-hidden bg-[#F5EF86] pb-10 pt-[120px] md:pt-[160px]">
            ...
            <div className="mx-auto flex w-full max-w-[1240px] flex-col gap-8 px-4 md:px-0">
                ...
                <PerforatedCard
                    ...
                    className="w-full"
                >
                    <div className="flex w-full flex-col gap-4 md:flex-row md:gap-0 md:justify-stretch">
                        {/* Left: Image */}
                        <div className="flex w-full p-4 md:w-[62%] md:p-8 md:pr-0">
                        ...
                        {/* Right: Details Card */}
                        <div className="flex w-full items-center justify-center p-4 md:w-[38%] md:p-8">
